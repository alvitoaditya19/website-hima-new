...
<head>
    ...
    <!-- Custom CSS -->
    <link rel="stylesheet" href="{{ asset('/styles/css/utilities.css') }}">
    <link rel="stylesheet" href="{{ asset('/styles/css/sign-in.css') }}">
    ...
    <section class="sign-in mx-auto">
        <div class="row">
                ...
                <form method="POST" action="{{ route('login') }}">
                    ...
                    <div class="container mx-auto">
                        ...
                        <div class="pt-30">
                            ...
                            <input type="password" class="form-control rounded-pill text-lg @error('password') is-invalid @enderror" id="password"
                        ...
                        <div class="button-group d-flex flex-column mx-auto pt-50">
                            <button type="submit" class="btn btn-sign-in fw-medium text-lg text-white rounded-pill mb-16"
                                href="{{ route('profile') }}" role="button">Continue to Sign In</button>
                            <!-- <button type="submit"
                            ...
                            <a class="btn btn-sign-up fw-medium text-lg color-palette-1 rounded-pill"
                                href="{{ route('register') }}" role="button">Sign
                                Up</a>
                        </div>
                    </div>
                </form>
            ...
            <div class="col-xxl-7 col-lg-6 bg-blue text-center pt-lg-145 pb-lg-145 d-lg-block d-none">
                <img src="/images/Header-9.png" width="502" height="391.21" class="img-fluid pb-50" alt="">
