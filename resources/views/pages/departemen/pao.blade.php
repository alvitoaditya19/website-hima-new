...
<html lang="en" dir="ltr">
   <head>
      ...
      <title>Himanitro UIN SGD Bandung - PAO</title>
...
<section class="heading-link">
  ...
  <p> <a href="index.html">home</a> / <a href="departemen.html">Departemen</a> / PAO</p>
</section>
...
<section class="departemen">
   ...
   <h1 class="heading"> Pengembangan Aparatur Organisasi </h1>

   <div class="row">

      <div class="image">
         <img src="images/himanitro/departemen/pao/logo-pao.png" alt="">
      </div>
...
<section class="faq">
   ...
   <h1 class="heading">frequently asked questions</h1>
      ...
      <div class="accordion-container">
         ...
         <div class="accordion">
            <div class="accordion-heading">
               <h3>Rapat Kerja dan Pleno Tengah</h3>
               <i class="fas fa-angle-down"></i>
            </div>
            <p class="accordion-content">
               Lorem ipsum dolor sit amet consectetur adipisicing elit. Reprehenderit libero magni totam iure delectus aliquid, nemo ipsam itaque laboriosam molestias, expedita voluptate quisquam ipsa exercitationem. Atque officia cum quia doloribus?
         ...
         <div class="accordion">
            <div class="accordion-heading">
               <h3>Pelatihan kepemimpinan dan upgrading</h3>
               <i class="fas fa-angle-down"></i>
            </div>
            <p class="accordion-content">
               Lorem ipsum dolor sit amet consectetur adipisicing elit. Reprehenderit libero magni totam iure delectus aliquid, nemo ipsam itaque laboriosam molestias, expedita voluptate quisquam ipsa exercitationem. Atque officia cum quia doloribus?
         ...
         <div class="accordion">
            <div class="accordion-heading">
               <h3>Diskusi Produk Hukum dan Organisasi</h3>
               <i class="fas fa-angle-down"></i>
            </div>
            <p class="accordion-content">
               Lorem ipsum dolor sit amet consectetur adipisicing elit. Reprehenderit libero magni totam iure delectus aliquid, nemo ipsam itaque laboriosam molestias, expedita voluptate quisquam ipsa exercitationem. Atque officia cum quia doloribus?
...
<!-------- faq section ends----->
<div class="anggota">
  <h1 class="heading">Our Team Departemen Rohani</h1>
    <div class="container">
          ...
          <div class="cards">
              <div class="card">
                <div class="content">
                  ...
                  <div class="details">
                    <div class="name">Fakhri Khusaini A</div>
            ...
            <div class="card">
             <div class="content">
               ...
               <div class="details">
                 <div class="name">Yola Yuliasmi</div>
            ...
            <div class="card">
             <div class="content">
               ...
               <div class="details">
                 <div class="name">Ahmad Hafidhuddin</div>
          ...
          <div class="cards">
            <div class="card">
             <div class="content">
               ...
               <div class="details">
                 <div class="name">Azfa Faly H</div>
                 <div class="job">Staff Departemen</div>
               </div>
               <div class="media-icons">
                 <a href="#"><i class="fab fa-facebook-f"></i></a>
            ...
            <div class="card">
             <div class="content">
               ...
               <div class="details">
                 <div class="name">Faisal Islami</div>
                 <div class="job">Staff Departemen</div>
               </div>
               <div class="media-icons">
                 <a href="#"><i class="fab fa-facebook-f"></i></a>
            ...
            <div class="card">
             <div class="content">
               ...
               <div class="details">
                 <div class="name">MUhammad Rafi K</div>
                 <div class="job">Staff Departemen</div>
               </div>
               <div class="media-icons">
                 <a href="#"><i class="fab fa-facebook-f"></i></a>
          ...
          <div class="cards">
            <div class="card">
             <div class="content">
               ...
               <div class="details">
                 <div class="name">Ryandini Arti</div>
                 <div class="job">Staff Departemen</div>
               </div>
               <div class="media-icons">
                 <a href="#"><i class="fab fa-facebook-f"></i></a>
            ...
            <div class="card">
             <div class="content">
               ...
               <div class="details">
                 <div class="name">Wina Febriani</div>
                 <div class="job">Staff Departemen</div>
               </div>
               <div class="media-icons">
                 <a href="#"><i class="fab fa-facebook-f"></i></a>
