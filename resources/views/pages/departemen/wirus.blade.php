...
<html lang="en" dir="ltr">
   <head>
      ...
      <title>Himanitro UIN SGD Bandung - Wirus</title>
...
<section class="heading-link">
  ...
  <p> <a href="index.html">home</a> / <a href="departemen.html">Departemen</a> / Wirus</p>
</section>
...
<section class="departemen">
   ...
   <h1 class="heading"> Kewirausahaan </h1>

   <div class="row">

      <div class="image">
         <img src="images/himanitro/departemen/wirus/logo-wirus.png" alt="">
      </div>
...
<section class="faq">
   ...
   <h1 class="heading">frequently asked questions</h1>
      ...
      <div class="accordion-container">
         ...
         <div class="accordion">
            <div class="accordion-heading">
               <h3>Elektro Digital Marketing</h3>
               <i class="fas fa-angle-down"></i>
            </div>
            <p class="accordion-content">
          ...
          <div class="cards">
              <div class="card">
                <div class="content">
                  ...
                  <div class="details">
                    <div class="name">Ilham Akbar D</div>
            ...
            <div class="card">
             <div class="content">
               ...
               <div class="details">
                 <div class="name">Gugun Saeful A</div>
            ...
            <div class="card">
             <div class="content">
               ...
               <div class="details">
                 <div class="name">Aditya Arif R</div>
          ...
          <div class="cards">
            <div class="card">
             <div class="content">
               ...
               <div class="details">
                 <div class="name">Dimas Rusdi</div>
                 <div class="job">Staff Departemen</div>
               </div>
               <div class="media-icons">
                 <a href="#"><i class="fab fa-facebook-f"></i></a>
            ...
            <div class="card">
             <div class="content">
               ...
               <div class="details">
                 <div class="name">Firdiansyah harianto</div>
                 <div class="job">Staff Departemen</div>
               </div>
               <div class="media-icons">
                 <a href="#"><i class="fab fa-facebook-f"></i></a>
            ...
            <div class="card">
             <div class="content">
               ...
               <div class="details">
                 <div class="name">M Rusdiawan</div>
                 <div class="job">Staff Departemen</div>
               </div>
               <div class="media-icons">
                 <a href="#"><i class="fab fa-facebook-f"></i></a>
          ...
          <div class="cards">
            <div class="card">
             <div class="content">
               ...
               <div class="details">
                 <div class="name">Putri Aurora</div>
                 <div class="job">Staff Departemen</div>
               </div>
               <div class="media-icons">
                 <a href="#"><i class="fab fa-facebook-f"></i></a>
