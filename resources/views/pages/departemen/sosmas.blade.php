...
<html lang="en" dir="ltr">
   <head>
      ...
      <title>Himanitro UIN SGD Bandung - Sosmas</title>
...
<section class="heading-link">
  ...
  <p> <a href="index.html">home</a> / <a href="departemen.html">Departemen</a> / Sosmas</p>
</section>
...
<section class="departemen">
   ...
   <h1 class="heading"> Sosial Masyarakat </h1>

   <div class="row">

      <div class="image">
         <img src="images/himanitro/departemen/sosmas/logo-sosmas.png" alt="">
      </div>
...
<section class="faq">
   ...
   <h1 class="heading">frequently asked questions</h1>
      ...
      <div class="accordion-container">
         ...
         <div class="accordion">
            <div class="accordion-heading">
               <h3>Himadik (HIMANITRO Mendidik)</h3>
               <i class="fas fa-angle-down"></i>
            </div>
            <p class="accordion-content">
               Lorem ipsum dolor sit amet consectetur adipisicing elit. Reprehenderit libero magni totam iure delectus aliquid, nemo ipsam itaque laboriosam molestias, expedita voluptate quisquam ipsa exercitationem. Atque officia cum quia doloribus?
...
<!-------- faq section ends----->
<div class="anggota">
  <h1 class="heading">Our Team Departemen Sosmas</h1>
    <div class="container">
          ...
          <div class="cards">
              <div class="card">
                <div class="content">
                  ...
                  <div class="details">
                    <div class="name">Feri Rivaldi</div>
            ...
            <div class="card">
             <div class="content">
               ...
               <div class="details">
                 <div class="name">Namira Aulia</div>
            ...
            <div class="card">
             <div class="content">
               ...
               <div class="details">
                 <div class="name">Adiksa M Fajar</div>
          ...
          <div class="cards">
            <div class="card">
             <div class="content">
               ...
               <div class="details">
                 <div class="name">Alisia Ine F</div>
                 <div class="job">Staff Departemen</div>
               </div>
               <div class="media-icons">
                 <a href="#"><i class="fab fa-facebook-f"></i></a>
            ...
            <div class="card">
             <div class="content">
               ...
               <div class="details">
                 <div class="name">Azmi Nurussyipa</div>
                 <div class="job">Staff Departemen</div>
               </div>
               <div class="media-icons">
                 <a href="#"><i class="fab fa-facebook-f"></i></a>
            ...
            <div class="card">
             <div class="content">
               ...
               <div class="details">
                 <div class="name">Dede Rifansyah</div>
                 <div class="job">Staff Departemen</div>
               </div>
               <div class="media-icons">
                 <a href="#"><i class="fab fa-facebook-f"></i></a>
          ...
          <div class="cards">
            <div class="card">
             <div class="content">
               ...
               <div class="details">
                 <div class="name">Moh Rido Fauzi</div>
                 <div class="job">Staff Departemen</div>
               </div>
               <div class="media-icons">
                 <a href="#"><i class="fab fa-facebook-f"></i></a>
            ...
            <div class="card">
              <div class="content">
                ...
                <div class="details">
                  <div class="name">Zidan Aditya</div>
                  <div class="job">Staff Departemen</div>
                </div>
                <div class="media-icons">
                  <a href="#"><i class="fab fa-facebook-f"></i></a>
