...
<html lang="en" dir="ltr">
   <head>
      ...
      <title>Himanitro UIN SGD Bandung - Profjur</title>
      ...
      <link rel="stylesheet" href="css/departemen2.css">
...
<div class="sidebar">
  ...
  <ul class="nav-list">
   ...
   <li>
     <a href="Himanitro News/index.html" target="_blank">
...
<section class="heading-link">
  ...
  <p> <a href="index.html">home</a> / <a href="departemen.html">Departemen</a> / Profjur</p>
</section>

<!------- contact section starts---->

<section class="departemen">

   <h1 class="heading"> Profesionalisme Jurusan </h1>

   <div class="row">

      <div class="image">
         <img src="images/himanitro/departemen/profjur/logo-profjur.png" alt="">
      </div>
   ...
   <h1 class="heading">frequently asked questions</h1>
      ...
      <div class="accordion-container">
         ...
         <div class="accordion active">
            ...
            <p class="accordion-content">Departemen PROFJUR (Profesionalisme Jurusan) adalah departemen yang bertujuan sebagai sarana untuk meningkatkan pengetahuan, kemampuan, dan keterampilan dalam keelektroan.</p>
         </div>

         <div class="accordion">
            <div class="accordion-heading">
               <h3>Pelatihan Ke-Elektroan</h3>
               <i class="fas fa-angle-down"></i>
            </div>
         ...
         <div class="accordion">
            <div class="accordion-heading">
               <h3>Pelatihan Mahasiswa Baru</h3>
               <i class="fas fa-angle-down"></i>
            </div>
            <p class="accordion-content">
               Lorem ipsum dolor sit amet consectetur adipisicing elit. Reprehenderit libero magni totam iure delectus aliquid, nemo ipsam itaque laboriosam molestias, expedita voluptate quisquam ipsa exercitationem. Atque officia cum quia doloribus?
...
<!-------- faq section ends----->
<div class="anggota">
  <h1 class="heading">Our Team Departemen Profjur</h1>
    <div class="container">
        ...
        <div class="main-card">
          <div class="cards">
              <div class="card">
                <div class="content">
                  <div class="img">
                    <img src="images/himanitro/profil.png" alt="">
                  </div>
                  <div class="details">
                    <div class="name">Aldi Anugrah Firdaus</div>
                    <div class="job">Ketua Departemen</div>
                  </div>
            ...
            <div class="card">
             <div class="content">
               ...
               <div class="details">
                 <div class="name">Heru Ramdani</div>
                 <div class="job">Sekretaris Departemen</div>
               </div>
               <div class="media-icons">
                 <a href="#"><i class="fab fa-facebook-f"></i></a>
                 <a href="#"><i class="fab fa-twitter"></i></a>
            ...
            <div class="card">
             <div class="content">
               ...
               <div class="details">
                 <div class="name">Rossy Musdawiyah A</div>
                 <div class="job">Bendahara Departemen</div>
               </div>
               <div class="media-icons">
                 <a href="#"><i class="fab fa-facebook-f"></i></a>
                 <a href="#"><i class="fab fa-twitter"></i></a>
          ...
          <div class="cards">
            <div class="card">
             <div class="content">
               ...
               <div class="details">
                 <div class="name">Ageng Ramadhan</div>
                 <div class="job">Staff departemen</div>
               </div>
               <div class="media-icons">
                 <a href="#"><i class="fab fa-facebook-f"></i></a>
                 <a href="#"><i class="fab fa-twitter"></i></a>
            ...
            <div class="card">
             <div class="content">
               ...
               <div class="details">
                 <div class="name">Deri Ruswandi</div>
                 <div class="job">Staff departemen</div>
               </div>
               <div class="media-icons">
                 <a href="#"><i class="fab fa-facebook-f"></i></a>
          ...
          <div class="cards">
            <div class="card">
             <div class="content">
               ...
               <div class="details">
                 <div class="name">Haddy Firdaus</div>
                 <div class="job">Staff departemen</div>
               </div>
               <div class="media-icons">
                 <a href="#"><i class="fab fa-facebook-f"></i></a>
            ...
            <div class="card">
             <div class="content">
               ...
               <div class="details">
                 <div class="name">Irham Fajrianto</div>
                 <div class="job">Staff departemen</div>
               </div>
               <div class="media-icons">
                 <a href="#"><i class="fab fa-facebook-f"></i></a>
          ...
          <div class="cards">
            <div class="card">
             <div class="content">
               ...
               <div class="details">
                 <div class="name">Shifa Ramdan N</div>
                 <div class="job">Staff departemen</div>
               </div>
               <div class="media-icons">
                 <a href="#"><i class="fab fa-facebook-f"></i></a>
