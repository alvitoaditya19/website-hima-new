...
<html lang="en" dir="ltr">
   <head>
      ...
      <title>Himanitro UIN SGD Bandung - Advokom</title>
...
<section class="heading-link">
   ...
   <p> <a href="index.html">home</a> / <a href="departemen.html">Departemen</a> / Advokom</p>
</section>
...
<section class="departemen">
   ...
   <h1 class="heading"> Advokom </h1>

   <div class="row">

      <div class="image">
         <img src="images/himanitro/departemen/advokom/logo-advokom.png" alt="">
      </div>
      ...
      <div class="accordion-container">
         ...
         <div class="accordion active">
            ...
            <p class="accordion-content">
                Departemen Adfokom(Adfokasi, Informasi, dan Komunikasi) adalah departemen yang bertujuan untuk mengadvokasi, menampungm menyalurkan dan menyampaikan aspirasi baik informasi internal maupun eksternal HIMANITRO.
            </p>
         </div>
...
<!-------- faq section ends----->
<div class="anggota">
  <h1 class="heading">Our Team Departemen Advokom</h1>
    <div class="container">
          ...
          <div class="cards">
              <div class="card">
                <div class="content">
                  ...
                  <div class="details">
                    <div class="name">Hedrico Ajey</div>
            ...
            <div class="card">
             <div class="content">
               ...
               <div class="details">
                 <div class="name">Rizki Muhammad S</div>
            ...
            <div class="card">
             <div class="content">
               ...
               <div class="details">
                 <div class="name">Lilien Ramadhani</div>
          ...
          <div class="cards">
            <div class="card">
             <div class="content">
               ...
               <div class="details">
                 <div class="name">Ahda Arif F</div>
                 <div class="job">Staff Departemen</div>
               </div>
               <div class="media-icons">
                 <a href="#"><i class="fab fa-facebook-f"></i></a>
            ...
            <div class="card">
             <div class="content">
               ...
               <div class="details">
                 <div class="name">Aldi Muhammad F</div>
                 <div class="job">Staff Departemen</div>
               </div>
               <div class="media-icons">
                 <a href="#"><i class="fab fa-facebook-f"></i></a>
            ...
            <div class="card">
             <div class="content">
               ...
               <div class="details">
                 <div class="name">M Saepulloh D</div>
                 <div class="job">Staff Departemen</div>
               </div>
               <div class="media-icons">
                 <a href="#"><i class="fab fa-facebook-f"></i></a>
          ...
          <div class="cards">
            <div class="card">
             <div class="content">
               ...
               <div class="details">
                 <div class="name">Muhammad Syauqi a</div>
                 <div class="job">Staff Departemen</div>
               </div>
               <div class="media-icons">
                 <a href="#"><i class="fab fa-facebook-f"></i></a>
            ...
            <div class="card">
             <div class="content">
               ...
               <div class="details">
                 <div class="name">Naufal Tsany q</div>
                 <div class="job">Staff Departemen</div>
               </div>
               <div class="media-icons">
                 <a href="#"><i class="fab fa-facebook-f"></i></a>
            ...
            <div class="card">
             <div class="content">
               ...
               <div class="details">
                 <div class="name">Rahayu Puspita</div>
                 <div class="job">Staff Departemen</div>
               </div>
               <div class="media-icons">
                 <a href="#"><i class="fab fa-facebook-f"></i></a>
          ...
          <div class="cards">
            <div class="card">
             <div class="content">
               ...
               <div class="details">
                 <div class="name">Sabrina Katresnawati</div>
                 <div class="job">Staff Departemen</div>
               </div>
               <div class="media-icons">
                 <a href="#"><i class="fab fa-facebook-f"></i></a>
