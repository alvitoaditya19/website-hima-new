...
<html lang="en" dir="ltr">
   <head>
      ...
      <title>Himanitro UIN SGD Bandung - Senior</title>
...
<section class="heading-link">
  ...
  <p> <a href="index.html">home</a> / <a href="departemen.html">Departemen</a> / Senior</p>
</section>
...
<section class="departemen">
   ...
   <h1 class="heading"> Seni dan Olahraga </h1>

   <div class="row">

      <div class="image">
         <img src="images/himanitro/departemen/senior/logo-senior.png" alt="">
      </div>
      ...
      <div class="accordion-container">
         ...
         <div class="accordion active">
            ...
            <p class="accordion-content">
                Departemen Senior (Seni dan Olahraga) adalah departemen yang bertujuan untuk menyelenggarakan kegiatan yang dapat membantu anggotanya dalam rangka menyalurkan dan meningkatkan bakat serta minat anggota HIMANITRO.
            </p>
         </div>
         ...
         <div class="accordion">
            <div class="accordion-heading">
               <h3>Pekan Olahraga dan Seni antar kelas(PORAK)</h3>
               <i class="fas fa-angle-down"></i>
            </div>
            <p class="accordion-content">
               Lorem ipsum dolor sit amet consectetur adipisicing elit. Reprehenderit libero magni totam iure delectus aliquid, nemo ipsam itaque laboriosam molestias, expedita voluptate quisquam ipsa exercitationem. Atque officia cum quia doloribus?
         ...
         <div class="accordion">
            <div class="accordion-heading">
               <h3>Pendakian bersama Teknik Elektro(PBTE)</h3>
               <i class="fas fa-angle-down"></i>
            </div>
            <p class="accordion-content">
               Lorem ipsum dolor sit amet consectetur adipisicing elit. Reprehenderit libero magni totam iure delectus aliquid, nemo ipsam itaque laboriosam molestias, expedita voluptate quisquam ipsa exercitationem. Atque officia cum quia doloribus?
         ...
         <div class="accordion">
            <div class="accordion-heading">
               <h3>Malam Keakraban Teknik Elektro(MAKARET)</h3>
               <i class="fas fa-angle-down"></i>
            </div>
            <p class="accordion-content">
               Lorem ipsum dolor sit amet consectetur adipisicing elit. Reprehenderit libero magni totam iure delectus aliquid, nemo ipsam itaque laboriosam molestias, expedita voluptate quisquam ipsa exercitationem. Atque officia cum quia doloribus?
...
<!-------- faq section ends----->
<div class="anggota">
  <h1 class="heading">Our Team Departemen Senior</h1>
    <div class="container">
          ...
          <div class="cards">
              <div class="card">
                <div class="content">
                  ...
                  <div class="details">
                    <div class="name">Alif Hilmi N</div>
            ...
            <div class="card">
             <div class="content">
               ...
               <div class="details">
                 <div class="name">Annisa Safa</div>
            ...
            <div class="card">
             <div class="content">
               ...
               <div class="details">
                 <div class="name">Elisa Apriliyani</div>
          ...
          <div class="cards">
            <div class="card">
             <div class="content">
               ...
               <div class="details">
                 <div class="name">Ismail Nurhapid</div>
                 <div class="job">Staff Departemen</div>
               </div>
               <div class="media-icons">
                 <a href="#"><i class="fab fa-facebook-f"></i></a>
            ...
            <div class="card">
             <div class="content">
               ...
               <div class="details">
                 <div class="name">Naufal Rizal</div>
                 <div class="job">Staff Departemen</div>
               </div>
               <div class="media-icons">
                 <a href="#"><i class="fab fa-facebook-f"></i></a>
            ...
            <div class="card">
             <div class="content">
               ...
               <div class="details">
                 <div class="name">Raden Dhiwa</div>
                 <div class="job">Staff Departemen</div>
               </div>
               <div class="media-icons">
                 <a href="#"><i class="fab fa-facebook-f"></i></a>
          ...
          <div class="cards">
            <div class="card">
             <div class="content">
               ...
               <div class="details">
                 <div class="name">Rizki Maharani</div>
                 <div class="job">Staff Departemen</div>
               </div>
               <div class="media-icons">
                 <a href="#"><i class="fab fa-facebook-f"></i></a>
