...
<html lang="en" dir="ltr">
   <head>
      ...
      <title>Himanitro UIN SGD Bandung - Ex-Officio</title>
      ...
      <link rel="stylesheet" href="/styles/css/departemen2.css">
...
<section class="heading-link">
  ...
  <p> <a href="index.html">home</a> / <a href="departemen.html">Departemen</a> / ex-Officio</p>
</section>
...
<section class="departemen">
   ...
   <h1 class="heading"> EX-OFFICIO </h1>

   <div class="row">

      <div class="image">
         <img src="images/himanitro/departemen/ex-officio/logo-kabinet.png" alt="">
      </div>
...
<!-------- faq section ends----->
<div class="anggota">
  <h1 class="heading">Our Team Ex-officio</h1>
    <div class="container">
          ...
          <div class="cards">
              <div class="card">
                <div class="content">
                  ...
                  <div class="details">
                    <div class="name">Abdi Syawal S</div>
                    <div class="job">Ketua Himpunan</div>
                  </div>
          ...
          <div class="cards">
            <div class="card">
              <div class="content">
                ...
                <div class="details">
                  <div class="name">Fahmi Fathurrahiman</div>
                  <div class="job">Sekretaris Umum</div>
                </div>
                <div class="media-icons">
                  <a href="#"><i class="fab fa-facebook-f"></i></a>
                  <a href="#"><i class="fab fa-twitter"></i></a>
            ...
            <div class="card">
             <div class="content">
               ...
               <div class="details">
                 <div class="name">Ayu Zumrotul K</div>
                 <div class="job">Wakil Sekum</div>
               </div>
               <div class="media-icons">
                 <a href="#"><i class="fab fa-facebook-f"></i></a>
                 <a href="#"><i class="fab fa-twitter"></i></a>
            ...
            <div class="card">
             <div class="content">
               ...
               <div class="details">
                 <div class="name">Nabilah Mutmainnah</div>
                 <div class="job">Wakil Sekum</div>
               </div>
               <div class="media-icons">
                 <a href="#"><i class="fab fa-facebook-f"></i></a>
          ...
          <div class="cards">
            <div class="card">
              <div class="content">
                ...
                <div class="details">
                  <div class="name">Aulia Yusa</div>
                  <div class="job">Bendahara Umum</div>
                </div>
                <div class="media-icons">
                  <a href="#"><i class="fab fa-facebook-f"></i></a>
                  <a href="#"><i class="fab fa-twitter"></i></a>
            ...
            <div class="card">
             <div class="content">
               ...
               <div class="details">
                 <div class="name">Siti Bilqis</div>
                 <div class="job">Wakil Bendum</div>
               </div>
               <div class="media-icons">
                 <a href="#"><i class="fab fa-facebook-f"></i></a>
                 <a href="#"><i class="fab fa-twitter"></i></a>
            ...
            <div class="card">
             <div class="content">
               ...
               <div class="details">
                 <div class="name">Fifa Nurfadilah</div>
                 <div class="job">Wakil Bendum</div>
               </div>
               <div class="media-icons">
                 <a href="#"><i class="fab fa-facebook-f"></i></a>
          ...
          <div class="cards">
            <div class="card">
              <div class="content">
                ...
                <div class="details">
                  <div class="name">Ilham Arrasyid M</div>
                  <div class="job">Biro kesekretariatan</div>
                </div>
                <div class="media-icons">
                  <a href="#"><i class="fab fa-facebook-f"></i></a>
                  <a href="#"><i class="fab fa-twitter"></i></a>
            ...
            <div class="card">
             <div class="content">
               ...
               <div class="details">
                 <div class="name">Farhan Romdoni</div>
                 <div class="job">Wakil Biro</div>
               </div>
               <div class="media-icons">
                 <a href="#"><i class="fab fa-facebook-f"></i></a>
                 <a href="#"><i class="fab fa-twitter"></i></a>
            ...
            <div class="card">
              <div class="content">
                ...
                <div class="details">
                  <div class="name">M. Riefqi Wijaya</div>
                  <div class="job">Wakil Biro</div>
                </div>
                <div class="media-icons">
                  <a href="#"><i class="fab fa-facebook-f"></i></a>
